...
gambar = cv2.imread('D:\Resources/l1.jpg')
prevCir = None
shoot = 15
scalling = 1
...
while True:
    ...
    cv2.circle(frame, (frame.shape[1]//2,frame.shape[0]//2),5,(0,0,255),2)
    ...
    if k == 1:
        ...
        if M['m00']!=0:
            ...
            cv2.line(frame, (cxH,0), (cxH,frame.shape[1]), (255,255,255), thickness=2)
            cv2.circle(frame, (cxH,cyH), 3, (0,0,255), thickness=3)
